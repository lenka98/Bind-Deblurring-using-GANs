...
parser.add_argument("--spectral_norm", action="store_true", help="use spectral norm" )
parser.add_argument("--add_attn", action="store_true")
parser.add_argument("--attn_type", default="both", choices=["spatial", "channelwise", "both"])
...
parser.add_argument("--loss_type", default="perpixel", choices=['perpixel', 'perceptual'])
parser.add_argument("--add_global_skip", action="store_true")
...
def conv(x, channels, kernel=4, stride=2, pad=0, pad_type='zero', padding = "SAME", use_bias=True, scope='conv'):
...
def deconv(x, channels, kernel=4, stride=2, padding='SAME', use_bias=True, scope='deconv'):
    with tf.variable_scope(scope):
